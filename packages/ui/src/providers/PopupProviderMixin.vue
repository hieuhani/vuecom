...
import popupManager from "../factories/PopupManager";
...
export default {
  ...
  beforeDestroy() {
    ...
    if (
      ...
      document &&
      this.popupElement &&
      this.popupElement.parentNode === document.body
    ) {
      this.popupElement.removeEventListener(
        "click",
        this.stopOnClickPropagation
      );
  ...
  methods: {
    ...
    createPopper() {
      ...
      this.referenceElement =
        this.referenceElement || this.reference || this.$refs.reference;
